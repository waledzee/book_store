        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form method='post' action="{{route('update_class')}}" class="pt-3">
                @csrf
                <div class="form-group" >
                  <select name="name" class="form-control form-control-lg" id="exampleFormControlSelect2">
                ...
                <div class="mt-3">
                <button type="submit" btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn>Update </button>
                </div>
